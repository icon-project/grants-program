# SodaX - February 2026 Progress Update

## Intro
This progress report is for SodaX related development work by Venture23 Team. 
The next phase of the project will focus on SodaX Phase 1 development and deployment. The report is from  1-Feb-2026 to 28-Feb-2026
...
| Partner fee Claiming |  Completed | Overall | https://github.com/icon-project/ICON-Projects-Planning/issues/602 |
| BTC Radfi Integration |  In Progress | Overall | https://github.com/icon-project/ICON-Projects-Planning/issues/624 |
| Stacks Integration |  In Progress | Overall | https://github.com/icon-project/ICON-Projects-Planning/issues/624 |
...
| Near Integration |  In Staging | Solver | https://github.com/icon-project/ICON-Projects-Planning/issues/614 |
| Curve on Arbitrum |  In Staging | Solver | https://github.com/icon-project/sodax-solver/issues/157 |
| Near Intent |  In Staging | Solver | https://github.com/icon-project/ICON-Projects-Planning/630 |
